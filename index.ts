...
export class TSCPrinter {
    ...
    /**
     * Draw content with windows font
     */
    public async windowsFont(command: Types.windowsFont): Promise<Boolean> {
        return NativeModules.RNTSCPrinter?.windowsFont(command)
    }
}
